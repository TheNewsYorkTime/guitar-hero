const chordArray = [
    ...
    [false,false,false,true], // 39
    [true,true,false,false],
    [false,false,false,true],
    [true,true,false,false]
];

export default chordArray;